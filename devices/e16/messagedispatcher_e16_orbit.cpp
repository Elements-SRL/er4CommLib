...
#include "messagedispatcher_e16_orbit.h"
#include "messagedispatcher.h"


MessageDispatcher_e16_Orbit::MessageDispatcher_e16_Orbit(string id):
    ...
    cFastCompensationControl.max = 2.5;
    cFastCompensationControl.steps = 16;
    cFastCompensationControl.step = cFastCompensationControl.max*15;
    cFastCompensationControl.decimals =0;
    ...
    fastPulseW1VoltageRange.min = 0;
    fastPulseW1VoltageRange.max = 500;
    fastPulseW1VoltageRange.step = 1;
    fastPulseW1VoltageRange.unit = "V";
    fastPulseW1VoltageRange.prefix = UnitPfxMilli;


    fastPulseW1TimeRange.min = INT28_MIN;
    fastPulseW1TimeRange.max = INT28_MAX;
    ...
    fastPulseW2DurationRange.min = INT28_MIN;
    fastPulseW2DurationRange.max = INT28_MAX;
    fastPulseW2DurationRange.step = 1.0;
    fastPulseW2DurationRange.unit = "s";
    fastPulseW2DurationRange.prefix = UnitPfxMilli;
    ...
    fastPulseW1VoltageCoder.resize(currentChannelsNum);
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 11;
    ...
    for (uint16_t channelIdx = 0; channelIdx < 8; channelIdx++) {

        doubleConfig.initialByte = 103+6*channelIdx;

        fastPulseW1VoltageCoder[channelIdx] = new DoubleSignAbsCoder(doubleConfig);
    }


    fastPulseW1TimeCoder.resize(currentChannelsNum);
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 28;
    ...
    for (uint16_t channelIdx = 0; channelIdx < 8; channelIdx++) {
        ...
        doubleConfig.initialByte = 105+6*channelIdx;

        fastPulseW1TimeCoder[channelIdx] = new DoubleSignAbsCoder(doubleConfig);
    }

    /*! Waveform 2*/

    fastPulseW2VoltageCoder.resize(currentChannelsNum);
    doubleConfig.initialBit = 151;
    doubleConfig.bitsNum = 13;
    ...
    for (uint16_t Idx = 0; Idx < 20; Idx++) {
        ...
        doubleConfig.initialByte = 151+6*Idx;
        fastPulseW2VoltageCoder[Idx] = new DoubleSignAbsCoder(doubleConfig);
    }


    fastPulseW2TimeCoder.resize(currentChannelsNum);
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 13;
    ...
    for (uint16_t Idx = 0; Idx < 20; Idx++) {
        ...
        doubleConfig.initialByte = 153+6*Idx;
        fastPulseW2TimeCoder[Idx] = new DoubleSignAbsCoder(doubleConfig);
    }

    fastPulseW2DurationCoder.resize(currentChannelsNum);
    doubleConfig.initialBit = 156;
    doubleConfig.bitsNum = 13;
    ...
    for (uint16_t Idx = 0; Idx < 20; Idx++) {
        ...
        doubleConfig.initialByte = 156+6*Idx;
    ...
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x00;  //ExPulse
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x01; //CFast
...
MessageDispatcher_e16_Orbit::~MessageDispatcher_e16_Orbit() {

}

void MessageDispatcher_e16_Orbit::initializeDevice() {
...
bool MessageDispatcher_e16_Orbit::checkProtocolValidity(string &message) {
    bool validFlag = true;
...
void MessageDispatcher_e16_Orbit::setFerdParameters() {
