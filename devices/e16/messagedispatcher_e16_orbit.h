#ifndef MESSAGEDISPATCHER_E16_ORBIT_H
#define MESSAGEDISPATCHER_E16_ORBIT_H


#include "messagedispatcher.h"

class MessageDispatcher_e16_Orbit: public MessageDispatcherLegacyEdr3 {
public:
    MessageDispatcher_e16_Orbit(string id);
    virtual ~MessageDispatcher_e16_Orbit();
...
#endif // MESSAGEDISPATCHER_E16_ORBIT_H
