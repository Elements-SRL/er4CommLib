...
MessageDispatcher_e16HC_V04::MessageDispatcher_e16HC_V04(string id) :
...
ErrorCodes_t MessageDispatcher_e16HC_V04::setGpRange(uint16_t gpRangeIdx, uint16_t channelIdx, bool applyFlag) {
...
ErrorCodes_t MessageDispatcher_e16HC_V04::getVoltageReferenceRanges(std::vector <RangedMeasurement_t> &ranges, uint16_t &defaultOption) {
    ranges.resize(1);
...
void MessageDispatcher_e16HC_V04::initializeDevice() {
...
bool MessageDispatcher_e16HC_V04::checkProtocolValidity(string &message) {
    bool validFlag = true;
...
ErrorCodes_t MessageDispatcher_e16HC_V04::updateVoltageOffsetCompensations(vector <Measurement_t> &offsets) {
...
void MessageDispatcher_e16HC_V04::updateVoltageReferenceOffsetCalibration() {
    /*! Voltage DAC Ext */
