...
MessageDispatcher_e16n_sine_V02::MessageDispatcher_e16n_sine_V02(string di) :
    MessageDispatcher_e16n_V01(di) {
...
MessageDispatcher_e16n_sine_V02::~MessageDispatcher_e16n_sine_V02() {

}

bool MessageDispatcher_e16n_sine_V02::checkProtocolValidity(string &message) {
    bool validFlag = true;
    message = "Valid protocol";
    switch (selectedProtocol) {
    case ProtocolConstant:
