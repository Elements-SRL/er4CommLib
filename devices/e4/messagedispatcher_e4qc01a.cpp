...
MessageDispatcher_e4qc01a_V01::MessageDispatcher_e4qc01a_V01(string di) :
    ...
    currentRangesArray[CurrentRange312_5pA].min = -312.5;
    currentRangesArray[CurrentRange312_5pA].max = 312.5;
    currentRangesArray[CurrentRange312_5pA].step = currentRangesArray[CurrentRange312_5pA].max/SHORT_MAX;
    currentRangesArray[CurrentRange312_5pA].prefix = UnitPfxPico;
    currentRangesArray[CurrentRange312_5pA].unit = "A";
    currentRangesArray[CurrentRange1_25nA].min = -1.25;
    currentRangesArray[CurrentRange1_25nA].max = 1.25;
    currentRangesArray[CurrentRange1_25nA].step = currentRangesArray[CurrentRange1_25nA].max/SHORT_MAX;
    currentRangesArray[CurrentRange1_25nA].prefix = UnitPfxNano;
    currentRangesArray[CurrentRange1_25nA].unit = "A";
    ...
    for (uint16_t channelIdx = 0; channelIdx < currentChannelsNum; channelIdx++) {
        defaultCurrentRangesIdx[channelIdx] = CurrentRange10nA;
    }
    ...
    voltageOffsetCompensationGain.value = 0.125;
    ...
    insertionPulseVoltageRange.step = 0.125;
    ...
    static_cast <BoolRandomArrayCoder *> (currentRangeCoders[0])->addMapItem(4); /*!< 312.5pA  -> 0b100 */
    static_cast <BoolRandomArrayCoder *> (currentRangeCoders[0])->addMapItem(2); /*!< 1.25nA   -> 0b010 */
    static_cast <BoolRandomArrayCoder *> (currentRangeCoders[0])->addMapItem(0); /*!< 10nA     -> 0b000 */
    static_cast <BoolRandomArrayCoder *> (currentRangeCoders[0])->addMapItem(1); /*!< 100nA    -> 0b001 */
    ...
    protocolAdimensionalCoders[ProtocolN] = new DoubleOffsetBinaryCoder(doubleConfig);
    doubleConfig.initialByte = 44;
    doubleConfig.initialBit = 0;
    doubleConfig.bitsNum = 10;
    ...
    protocolAdimensionalCoders[ProtocolNR] = new DoubleOffsetBinaryCoder(doubleConfig);
    ...
    doubleConfig.maxValue = protocolVoltageRanges[ProtocolVHold].max;
    for (uint16_t channelIdx = 0; channelIdx < currentChannelsNum; channelIdx++) {
        doubleConfig.initialByte = 12+2*channelIdx;
    ...
    txStatus[txStatusIdx++] = 0x40; // CFG7
    txStatus[txStatusIdx++] = 0x40; // CFG8
...
bool MessageDispatcher_e4qc01a_V01::checkProtocolValidity(string &message) {
    bool validFlag = true;
...
ErrorCodes_t MessageDispatcher_e4qc01a_V01::updateVoltageOffsetCompensations(vector <Measurement_t> &offsets) {
