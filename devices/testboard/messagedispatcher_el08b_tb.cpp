...
MessageDispatcher_EL08b_TB::MessageDispatcher_EL08b_TB(string di) :
    ...
    currentRangesArray[CurrentRange1000nA].min = -1000.0;
    currentRangesArray[CurrentRange1000nA].max = 1000.0;
    currentRangesArray[CurrentRange1000nA].step = currentRangesArray[CurrentRange1000nA].max/SHORT_MAX;
    currentRangesArray[CurrentRange1000nA].prefix = UnitPfxNano;
    currentRangesArray[CurrentRange1000nA].unit = "A";
    defaultCurrentRangesIdx.resize(currentChannelsNum);
    for (uint16_t channelIdx = 0; channelIdx < currentChannelsNum; channelIdx++) {
        defaultCurrentRangesIdx[channelIdx] = CurrentRange1nA;
    }
    ...
    voltageStimulusLpfOptions[VoltageStimulusLpf26Hz].value = 26.0;
    voltageStimulusLpfOptions[VoltageStimulusLpf26Hz].prefix = UnitPfxNone;
    voltageStimulusLpfOptions[VoltageStimulusLpf26Hz].unit = "Hz";
    ...
    customOptionsNames[CustomOptionZapLevel] = "Zap Level";
    customOptionsDescriptions.resize(customOptionsNum);
    customOptionsDescriptions[CustomOptionZapLevel].resize(8);
    customOptionsDescriptions[CustomOptionZapLevel][0] = "0V";
    customOptionsDescriptions[CustomOptionZapLevel][1] = "0.7V";
    customOptionsDescriptions[CustomOptionZapLevel][2] = "1.05V";
    customOptionsDescriptions[CustomOptionZapLevel][3] = "1.65V";
    customOptionsDescriptions[CustomOptionZapLevel][4] = "2.25V";
    customOptionsDescriptions[CustomOptionZapLevel][5] = "2.6V";
    customOptionsDescriptions[CustomOptionZapLevel][6] = "2.95V";
    customOptionsDescriptions[CustomOptionZapLevel][7] = "3.3V";
    customOptionsDefault.resize(customOptionsNum);
    customOptionsDefault[CustomOptionZapLevel] = 0;
    ...
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 2;
    BoolArrayCoder * iFiltCoder = new BoolArrayCoder(boolConfig);
    ...
    static_cast <EnsembleCoder *> (samplingRateCoder)->addMapItem(0x30); /*!< 5kHz   BW CK/8 1.25kHz -> 0b00110000 */
    static_cast <EnsembleCoder *> (samplingRateCoder)->addMapItem(0x31); /*!< 5kHz   BW CK/8 2.5kHz  -> 0b00110001 */
    static_cast <EnsembleCoder *> (samplingRateCoder)->addMapItem(0x32); /*!< 5kHz   BW CK/4 5kHz    -> 0b00100010 */
    static_cast <EnsembleCoder *> (samplingRateCoder)->addMapItem(0x63); /*!< 10kHz  BW CK/4 10kHz   -> 0b01100011 */
    static_cast <EnsembleCoder *> (samplingRateCoder)->addMapItem(0x94); /*!< 20kHz  BW CK/2 20kHz   -> 0b10010100 */
    static_cast <EnsembleCoder *> (samplingRateCoder)->addMapItem(0xD5); /*!< 100kHz BW CK/2 50kHz   -> 0b11010101 */
    static_cast <EnsembleCoder *> (samplingRateCoder)->addMapItem(0xC6); /*!< 100kHz BW CK/1 100kHz  -> 0b11000110 */
    static_cast <EnsembleCoder *> (samplingRateCoder)->addMapItem(0xC7); /*!< 100kHz BW CK/1 200kHz  -> 0b11000111 */

    boolConfig.initialByte = 92;
    boolConfig.initialBit = 0;
    boolConfig.bitsNum = 3;
    customOptionsCoders.resize(customOptionsNum);
    customOptionsCoders[CustomOptionZapLevel] = new BoolArrayCoder(boolConfig);
    ...
    static_cast <BoolRandomArrayCoder *> (dacIntFilterCoder)->addMapItem(3); // 26Hz
    ...
    txStatus[txStatusIdx++] = 0x07; // CFG2
    txStatus[txStatusIdx++] = 0x07; // CFG3
    txStatus[txStatusIdx++] = 0x07; // CFG4
    txStatus[txStatusIdx++] = 0x07; // CFG5
    txStatus[txStatusIdx++] = 0x07; // CFG6
    txStatus[txStatusIdx++] = 0x07; // CFG7
    txStatus[txStatusIdx++] = 0x07; // CFG8
    txStatus[txStatusIdx++] = 0x07; // CFG9
    txStatus[txStatusIdx++] = 0x00; // ranges
    txStatus[txStatusIdx++] = 0x00; // ranges
    txStatus[txStatusIdx++] = 0x00; // filters
    txStatus[txStatusIdx++] = 0x00; // filters
    txStatus[txStatusIdx++] = 0x00; // protocol
    ...
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x00; // ch off
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x7f; // ch sel
    txStatus[txStatusIdx++] = 0x01;
    txStatus[txStatusIdx++] = 0x00; // ch zap
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x00; // digital offset compensation
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x00; // zap level
}

MessageDispatcher_EL08b_TB::~MessageDispatcher_EL08b_TB() {

}

void MessageDispatcher_EL08b_TB::initializeDevice() {
...
bool MessageDispatcher_EL08b_TB::checkProtocolValidity(string &message) {
    bool validFlag = true;
