...
typedef enum {
    ...
    DeviceENPRHC_EL06g_FWV01,               /*!< eNPR-HC with EL06g */
    ...
    TestboardEL09a,                         /*!< testboard chip EL09a */
    TestboardEL08b,                         /*!< testboard chip EL08b */
    TestboardEL10a,                         /*!< testboard chip EL10a */
    ...
    DeviceOrbitMiniSineAndTriggerIn,        /*!< Orbit mini prototype with additional protocols that resemble the standard ones with an additive sinusoid and with input trigger. */
    DeviceOrbitMiniSineAndTriggerIn_FwV02,  /*!< Orbit mini prototype with additional protocols that resemble the standard ones with an additive sinusoid and with input trigger. */
