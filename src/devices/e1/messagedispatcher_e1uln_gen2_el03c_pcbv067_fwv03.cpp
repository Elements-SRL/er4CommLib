...
MessageDispatcher_e1ULN_Gen2_EL03c_PCBV067_FWV03::MessageDispatcher_e1ULN_Gen2_EL03c_PCBV067_FWV03(string di) :
    ...
    voltageRangesArray[VoltageRange700mV].min = -700;
    voltageRangesArray[VoltageRange700mV].max = 700;
    ...
    protocolFrequencyRangesArray[ProtocolFrequencyRange4_5kHz].min = 0.0;
    protocolFrequencyRangesArray[ProtocolFrequencyRange4_5kHz].max = 4.5;
    protocolFrequencyRangesArray[ProtocolFrequencyRange4_5kHz].step = 1.0e-3;
    protocolFrequencyRangesArray[ProtocolFrequencyRange4_5kHz].prefix = UnitPfxKilo;
    protocolFrequencyRangesArray[ProtocolFrequencyRange4_5kHz].unit = "Hz";
    ...
    protocolsNames[ProtocolSin] = "Sine";
    ...
    protocolsAvailableVoltages[ProtocolSin].push_back(ProtocolVHold);
    protocolsAvailableVoltages[ProtocolSin].push_back(ProtocolVSine);
    protocolsAvailableFrequencies[ProtocolSin].push_back(ProtocolFrequency);
    ...
    protocolVoltageRanges[ProtocolVHold].min = voltageRangesArray[VoltageRange700mV].min;
    protocolVoltageRanges[ProtocolVHold].max = voltageRangesArray[VoltageRange700mV].max;
    ...
    protocolVoltageRanges[ProtocolVPulse].min = voltageRangesArray[VoltageRange700mV].min;
    protocolVoltageRanges[ProtocolVPulse].max = voltageRangesArray[VoltageRange700mV].max;
    ...
    protocolVoltageRanges[ProtocolVStep].min = voltageRangesArray[VoltageRange700mV].min;
    protocolVoltageRanges[ProtocolVStep].max = voltageRangesArray[VoltageRange700mV].max;
    ...
    protocolVoltageRanges[ProtocolVFinal].min = voltageRangesArray[VoltageRange700mV].min;
    protocolVoltageRanges[ProtocolVFinal].max = voltageRangesArray[VoltageRange700mV].max;
    ...
    protocolVoltageRanges[ProtocolVInit].min = voltageRangesArray[VoltageRange700mV].min;
    protocolVoltageRanges[ProtocolVInit].max = voltageRangesArray[VoltageRange700mV].max;
    protocolVoltageRanges[ProtocolVInit].prefix = UnitPfxMilli;
    protocolVoltageRanges[ProtocolVInit].unit = "V";
    protocolVoltageRanges[ProtocolVSine].step = 0.0625;
    protocolVoltageRanges[ProtocolVSine].min = voltageRangesArray[VoltageRange700mV].min;
    protocolVoltageRanges[ProtocolVSine].max = voltageRangesArray[VoltageRange700mV].max;
    ...
    protocolFrequencyRanges[ProtocolFrequency].max = UINT21_MAX*protocolFrequencyRanges[ProtocolFrequency].step;
    ...
    doubleConfig.maxValue = protocolVoltageRanges[ProtocolVHold].max;
    for (uint16_t channelIdx = 0; channelIdx < currentChannelsNum; channelIdx++) {
        doubleConfig.initialByte = 53+3*channelIdx;
    ...
    txStatus[txStatusIdx++] = 0x00; // voltage ranges
    txStatus[txStatusIdx++] = 0x00; // current ranges
    txStatus[txStatusIdx++] = 0x00; // voltage filters
    txStatus[txStatusIdx++] = 0x00; // current filters
    txStatus[txStatusIdx++] = 0x00; // protocol CFG
    ...
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x00;
    txStatus[txStatusIdx++] = 0x00; // Ch_off
...
MessageDispatcher_e1ULN_Gen2_EL03c_PCBV067_FWV03::~MessageDispatcher_e1ULN_Gen2_EL03c_PCBV067_FWV03() {

}

void MessageDispatcher_e1ULN_Gen2_EL03c_PCBV067_FWV03::initializeDevice() {
...
bool MessageDispatcher_e1ULN_Gen2_EL03c_PCBV067_FWV03::checkProtocolValidity(string &message) {
    bool validFlag = true;
    message = "Valid protocol";
    switch (selectedProtocol) {
    case ProtocolConstant:
        if (!(protocolVoltageRangesArray[ProtocolVoltageRange700mV].includes(selectedProtocolVoltage[ProtocolVHold]))) {
            validFlag = false;
    ...
    case ProtocolTriangular:
        if (!(protocolVoltageRangesArray[ProtocolVoltageRange700mV].includes(selectedProtocolVoltage[ProtocolVHold]+selectedProtocolVoltage[ProtocolVPk]))) {
            validFlag = false;
            message = "Vhold+Vamp\nmust be within [-700,700]mV";

        } else if (!(protocolVoltageRangesArray[ProtocolVoltageRange700mV].includes(selectedProtocolVoltage[ProtocolVHold]-selectedProtocolVoltage[ProtocolVPk]))) {
            validFlag = false;
            message = "Vhold-Vamp\nmust be within [-700,700]mV";
    ...
    case ProtocolSquareWave:
        if (!(protocolVoltageRangesArray[ProtocolVoltageRange700mV].includes(selectedProtocolVoltage[ProtocolVHold]+selectedProtocolVoltage[ProtocolVPulse]))) {
            validFlag = false;
    ...
    case ProtocolRamp:
        ...
        } else if (!(protocolVoltageRangesArray[ProtocolVoltageRange700mV].includes(selectedProtocolVoltage[ProtocolVFinal]))) {
            validFlag = false;
            message = "Vfinal\nmust be within [-700,700]mV";

        } else if (!(protocolVoltageRangesArray[ProtocolVoltageRange700mV].includes(selectedProtocolVoltage[ProtocolVInit]))) {
            validFlag = false;
            message = "Vinit\nmust be within [-700,700]mV";
    ...
    case ProtocolSin:
        ...
        } else if (!(protocolFrequencyRangesArray[ProtocolFrequencyRange4_5kHz].includes(selectedProtocolFrequency[ProtocolFrequency]))) {
            validFlag = false;
...
void MessageDispatcher_e1ULN_Gen2_EL03c_PCBV067_FWV03::setFerdParameters() {
...
ErrorCodes_t MessageDispatcher_e1ULN_Gen2_EL03c_PCBV067_FWV03::updateVoltageOffsetCompensations(vector <Measurement_t> &offsets) {
