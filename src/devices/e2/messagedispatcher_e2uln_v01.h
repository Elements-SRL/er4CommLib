#ifndef MESSAGEDISPATCHER_E2ULN_V01_H
#define MESSAGEDISPATCHER_E2ULN_V01_H
...
class MessageDispatcher_e2uln_V01 : public MessageDispatcher {
public:
    MessageDispatcher_e2uln_V01(std::string di);
...
#endif // MESSAGEDISPATCHER_E2ULN_V01_H
