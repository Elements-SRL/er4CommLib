...
#include "messagedispatcher_e1light_gen2_el03c_pcbulnv067.h"
#include "messagedispatcher_e1_e4nbased.h"
#include "messagedispatcher_enpr.h"
#include "messagedispatcher_enpr_hc.h"
#include "messagedispatcher_enpr_hc_el06g_pcbv01_fwv01.h"
...
static const vector <vector <uint32_t>> deviceTupleMapping = {
    ...
    {DeviceVersionENPR, DeviceSubversionE2QcDebug, 130, DeviceE2QcDebug},                                       //    8, 10,130 : eNPR debug device for chip QC01a
    {DeviceVersionENPR, DeviceSubversionE2QcDebug, 131, DeviceE2QcDebug},                                       //    8, 10,131 : eNPR debug device for chip QC01a
    {DeviceVersionENPR, DeviceSubversionE2QcDebug, 132, DeviceE2QcDebug},                                       //    8, 10,132 : eNPR debug device for chip QC01a
    {DeviceVersionENPR, DeviceSubversionE2QcDebugIntVcm, 130, DeviceE2QcDebugIntVcm},                           //    8, 11,130 : eNPR debug device for chip QC01a with Vcm internally generated by core 1
    {DeviceVersionENPR, DeviceSubversionE2QcDebugIntVcm, 131, DeviceE2QcDebugIntVcm},                           //    8, 11,131 : eNPR debug device for chip QC01a with Vcm internally generated by core 1
    {DeviceVersionENPR, DeviceSubversionE2QcDebugIntVcm, 132, DeviceE2QcDebugIntVcm},                           //    8, 11,132 : eNPR debug device for chip QC01a with Vcm internally generated by core 1
    {DeviceVersionENPR, DeviceSubversionENPRHcEL06g, 1, DeviceENPRHC_EL06g_FWV01},                              //    8, 12,  1 : eNPR-HC with El06g
    {DeviceVersionE4, DeviceSubversionE4n, 10, DeviceE4nEDR3_V04},                                              //    4,  3, 10 : e4n with old ramp protocols (Legacy version for EDR3)
    ...
    {DeviceVersionE16, DeviceSubversionE16FastPulses, 4, DeviceE16FastPulsesEDR3},                              //    3,  4,  4 : e16n customized for fast pulses (Legacy version for EDR3)
    {DeviceVersionE16, DeviceSubversionE16n, 135, DeviceE16n},                                                  //    3,  5,135 : e16n TC
    {DeviceVersionE16, DeviceSubversionE16n, 136, DeviceE16n},                                                  //    3,  5,136 : e16n TC
    ...
    {DeviceVersionPrototype, DeviceSubversionProtoOrbitMiniSineWave, 1, DeviceOrbitMiniSineAndTriggerIn},       //  254, 18,  1 : e4n prototype with additional protocols that resemble the standard ones with an additive sinusoid and with input trigger
    {DeviceVersionPrototype, DeviceSubversionProtoOrbitMiniSineWave, 1, DeviceOrbitMiniSineAndTriggerIn_FwV02}, //  254, 18,  2 : e4n prototype with additional protocols that resemble the standard ones with an additive sinusoid and with input trigger
...
ErrorCodes_t MessageDispatcher::connectDevice(std::string deviceId, MessageDispatcher *&messageDispatcher) {
    ...
    case DeviceE1LightGen2EL03c_PCBULNV067:
        messageDispatcher = new MessageDispatcher_e1Light_Gen2_EL03c_PCBULNV067(deviceId);
        break;
    ...
    case DeviceENPRHC_EL06g_FWV01:
        messageDispatcher = new MessageDispatcher_eNPR_HC_EL06g_PCBV01_FWV01(deviceId);
        break;
    ...
    case DeviceE2QcDebugIntVcm:
        messageDispatcher = new MessageDispatcher_e2qc_debug_interval_vcm(deviceId);
        break;
    ...
    case DeviceE16nEL08a:
        messageDispatcher = new MessageDispatcher_e16n_EL08a_V01(deviceId);
        break;
    ...
    case TestboardEL09a:
        messageDispatcher = new MessageDispatcher_EL09a_TB(deviceId);
        break;
    ...
    case DeviceOrbitMiniSineAndTriggerIn:
        messageDispatcher = new MessageDispatcher_e4n_SineInputSync(deviceId);
        break;

    case DeviceOrbitMiniSineAndTriggerIn_FwV02:
        messageDispatcher = new MessageDispatcher_e4n_SineInputSync_FwV02(deviceId);
        break;
