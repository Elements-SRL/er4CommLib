...
static const vector <vector <uint32_t>> deviceTupleMapping = {
    ...
    {DeviceVersionPrototype, DeviceSubversionProtoOrbitMiniSineWave, 2, DeviceOrbitMiniSineAndTriggerIn_FwV02}, //  254, 18,  2 : e4n prototype with additional protocols that resemble the standard ones with an additive sinusoid and with input trigger
